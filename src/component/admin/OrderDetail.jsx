const OrderDetail = () => {
    return (
        <div>
            ...
            <div className="py-5">
                {/* text  */}
                <h1 className=" text-xl text-sky-400 font-bold">All Order</h1>
            </div>

            {/* table  */}
            <div className="w-full overflow-x-auto">
                <table className="w-full text-left border border-collapse sm:border-separate border-sky-100 text-sky-400" >
                    <tbody>
                        <tr>
