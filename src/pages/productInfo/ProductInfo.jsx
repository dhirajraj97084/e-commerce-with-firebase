...
const ProductInfo = () => {
    return (
        <Layout>
            <section className="py-5 lg:py-16 font-poppins bg-gray-200">
                    ...
                    <div className="flex flex-wrap mb-24 -mx-4">
                        ...
                        <div className="w-full px-4 md:w-1/2">
                            <div className="lg:pl-20">
                                <div className="mb-6 ">
                                    <h2 className="max-w-xl mb-6 text-xl font-semibold leading-loose tracking-wide text-black md:text-2xl dark:text-gray-700">
                                            ...
                                            <li>
                                                <a href="">
                                                    <svg
                                                        ...
                                                        height={16}
                                                        fill="currentColor"
                                                        className="w-4 mr-1 text-red-500 dark:text-gray-600 bi bi-star "
                                                        viewBox="0 0 16 16"
                                                    >
                                ...
                                <div className="flex flex-wrap items-center mb-6">
                                    ...
                                    <button
                                        className="w-full px-4 py-3 text-center text-black bg-sky-400 border border-sky-600  hover:bg-sky-600 hover:text-gray-100 rounded-xl"
                                    >
                                        Add to cart
                                    </button>
                                </div>
