                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="flex gap-4 mb-6">
                                    <button
                                        className="w-full px-4 py-3 text-center text-gray-100 bg-sky-600 border border-transparent dark:border-gray-700 hover:border-sky-500 hover:text-sky-700 hover:bg-pink-100 rounded-xl"
                                    >
                                        Buy now
                                    </button>
                                </div>
